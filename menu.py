...
def gerenciar_notas():
    ...
    escolha_numero_turma = input("Digite o número da turma para gerenciar notas: ")
    ...
    try:
        ...
        if 1 <= escolha_numero_turma <= len(turmas_disponiveis):
            ...
            if alunos_na_turma:
                ...
                escolha_aluno_notas = input("\nDigite o número do aluno para gerenciar notas: ")
                    ...
                    if 1 <= escolha_aluno_notas <= len(alunos_na_turma):
                        ...
                        if colunas_ciclos:
                            ...
                            for i, coluna_ciclo in enumerate(colunas_ciclos):
                                ...
                                nota = float(input(f"Digite a nota para o Ciclo {ciclo_nome} do aluno {nome_aluno}: "))
                            ...
                            print(f"\nNotas do aluno '{cpf_aluno}' adicionadas/alteradas com sucesso.")
                        else:
